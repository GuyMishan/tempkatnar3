...
import SubAdminNavbar from '../components/Navbars/subadminNavbar'
...
const AdminSchedule = () => {
    ...
    return (
        <div>
            ...
            <div className="header bg-gradient-blue py-5 " style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
